                        ...
                        <div class="header-mb-middle header-mb-items">
                            ...
                            <div class="header-logo">
                                ...
                                <a class="logo-img" href="/" title="Logo">
                                    <img src="/media/logo/Logo with Inverted Palette - No Background.png" alt="priya" itemprop="logo"
                            ...
                            <div class="left-header header-items">
                                <div class="header-logo" itemscope>
                                    ...
                                    <a class="logo-img" href="/index.html" title="Logo">
                                        <img src="/media/logo/Vector logo - No Background.png  " alt="COMPANY_LOGO"
                                        ...
                                        <nav class="nav-bar" role="navigation">
                                            ...
                                            <ul class="site-nav">
                                                ...
                                                <li class=" menu-lv-1 item dropdown no-mega-menu">
                                                    <a class="menu__moblie " href="/pages/about_us.html">
                                                ...
                                                <li class=" menu-lv-1 item dropdown no-mega-menu">
                                                    <a class="menu__moblie " href="/pages/contact_us.html">
                                                ...
                                                <li class=" menu-lv-1 item dropdown no-mega-menu">
                                                    <a class="menu__moblie " href="/pages/store_location.html">
        ...
        <style>
            @media (min-width:1200px) {
                ...
                .site-nav .mega-menu .style_5 .mega-banner.skin-3.skin-3-product:after {
                    background-color: #163434 !important;
                }
